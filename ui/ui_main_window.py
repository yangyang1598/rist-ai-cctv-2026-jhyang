...
################################################################################
## Form generated from reading UI file 'main_windowGzErIr.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_clock_widget.setFont(font1)
        ...
        font2.setBold(True)
        self.label_cctv_connection_status.setFont(font2)
        ...
        self.label_cctv_connection_status_widget.setFont(font1)
        ...
        self.label_cctv_list_widget.setFont(font1)
        ...
        self.label_video_layout_widget.setFont(font1)
        ...
        self.label_ptz_controller.setFont(font2)
        ...
        self.label_ptz_controller_widget.setFont(font1)
        ...
        sizePolicy1.setHeightForWidth(self.button_video_player_layout_1x1.sizePolicy().hasHeightForWidth())
        self.button_video_player_layout_1x1.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.button_video_player_layout_2x2.sizePolicy().hasHeightForWidth())
        self.button_video_player_layout_2x2.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.button_video_player_layout_3x3.sizePolicy().hasHeightForWidth())
        self.button_video_player_layout_3x3.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.button_video_player_layout_4x4.sizePolicy().hasHeightForWidth())
        self.button_video_player_layout_4x4.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.button_video_player_layout_5x5.sizePolicy().hasHeightForWidth())
        self.button_video_player_layout_5x5.setSizePolicy(sizePolicy1)
        ...
        self.button_add_tab = QPushButton(self.centralwidget)
        self.button_add_tab.setObjectName(u"button_add_tab")
        sizePolicy1.setHeightForWidth(self.button_add_tab.sizePolicy().hasHeightForWidth())
        self.button_add_tab.setSizePolicy(sizePolicy1)
        self.button_add_tab.setMinimumSize(QSize(50, 0))

        self.horizontalLayout_7.addWidget(self.button_add_tab)

        self.button_remove_tab = QPushButton(self.centralwidget)
        self.button_remove_tab.setObjectName(u"button_remove_tab")
        sizePolicy1.setHeightForWidth(self.button_remove_tab.sizePolicy().hasHeightForWidth())
        self.button_remove_tab.setSizePolicy(sizePolicy1)
        self.button_remove_tab.setMinimumSize(QSize(50, 0))

        self.horizontalLayout_7.addWidget(self.button_remove_tab)
        ...
        self.label_snapshot_image_widget.setFont(font3)
        ...
        self.button_ai_event_image_log = QPushButton(self.centralwidget)
        self.button_ai_event_image_log.setObjectName(u"button_ai_event_image_log")

        self.horizontalLayout_3.addWidget(self.button_ai_event_image_log)
        ...
        self.label_ai_event_log_widget.setFont(font1)
        ...
        self.label_event_log_image_widget.setFont(font1)
        ...
        self.layout_right.setStretch(1, 4)
        self.layout_right.setStretch(2, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_ai_event_image_log.setText(QCoreApplication.translate("MainWindow", u"\u205d", None))
